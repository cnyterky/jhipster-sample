package com.cnyterky.myapp.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.cnyterky.myapp.service.EmailAlreadyUsedException ||
            ex instanceof com.cnyterky.myapp.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.cnyterky.myapp.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.cnyterky.myapp");
    }
}
